...
export async function CTA() {
  ...
  return (
    <section className="relative z-10 w-full py-32 border-t border-black/5 bg-black/5">
      <div className="grid grid-cols-1 md:grid-cols-4 w-full h-full">
        <div className="col-span-1 md:col-span-3 px-6 md:px-8 flex flex-col justify-center">
          <h2 className="text-4xl sm:text-6xl md:text-8xl font-medium tracking-tighter text-black mb-6">
            {t("ctaTitle")}
          </h2>
        ...
        <div className="col-span-1 px-6 md:px-8 flex items-center justify-start md:justify-end mt-12 md:mt-0">
          <Button size="lg" asChild className="bg-black text-white hover:bg-black/90 rounded-none px-10 h-16 text-lg w-full md:w-auto">
