      ...
      <div className="grid grid-cols-1 md:grid-cols-4 w-full mb-24">
        ...
        <div className="col-span-1 px-6 md:px-8 border-r border-transparent">
          ...
          <ul className="space-y-4 text-sm text-black/80">
            ...
            <li><Link href="#" className="hover:text-black transition-colors">Book a Call</Link></li>
          </ul>
        </div>
        ...
        <div className="col-span-1 px-6 md:px-8">
          ...
          <ul className="space-y-4 text-sm text-black/80 mb-8">
          ...
          <div className="flex items-center gap-4">
            <Link href="#" className="p-2 border border-black/10 rounded-md hover:bg-black/5 transition-colors"><Twitter className="h-4 w-4 text-black" /></Link>
            <Link href="#" className="p-2 border border-black/10 rounded-md hover:bg-black/5 transition-colors"><Linkedin className="h-4 w-4 text-black" /></Link>
            <Link href="#" className="p-2 border border-black/10 rounded-md hover:bg-black/5 transition-colors"><Youtube className="h-4 w-4 text-black" /></Link>
            <Link href="#" className="p-2 border border-black/10 rounded-md hover:bg-black/5 transition-colors"><Instagram className="h-4 w-4 text-black" /></Link>
          </div>
        </div>
      </div>

      <div className="relative w-full flex items-center justify-center px-4">
        <h2 className="text-[12vw] sm:text-[14vw] font-bold tracking-tighter text-black leading-none pb-8">
          FormMitra
        </h2>
      </div>

      <div className="mt-8 flex flex-col md:flex-row items-center justify-between text-xs text-muted-foreground pt-8 px-6 md:px-8 border-t border-black/10">
        <p>{t("copyright")}</p>
