    ...
    <section className="relative z-10 w-full py-24 border-t border-white/5">
      <div className="grid grid-cols-1 md:grid-cols-4 w-full">
        <div className="col-span-1 px-6 md:px-8 border-r border-transparent mb-12 md:mb-0">
          <h2 className="text-2xl md:text-3xl font-medium tracking-tight text-white">{t("workflowTitle")}</h2>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 w-full mt-12 md:mt-24">
        {STEPS.map((s) => (
          <div key={s.num} className="col-span-1 px-6 md:px-8 flex flex-col mb-12 md:mb-0 border-r border-transparent">
            <div className="text-7xl font-mono text-white/10 mb-8 font-bold">{s.num}</div>
            <h3 className="font-mono text-2xl font-bold tracking-tight text-white mb-4">{s.title}</h3>
